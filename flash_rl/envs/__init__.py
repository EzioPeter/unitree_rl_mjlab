    ...
    **kwargs: Any,
    ...
    if env_type in ["dmc", "mujoco", "humanoid_bench", "metaworld", "myosuite", "d4rl"]:
        ...
        train_env = make_mjlab_env(
            ...
            seed=seed,
            device=device,
            use_domain_randomization=kwargs.get("use_domain_randomization", True),
            use_push_randomization=kwargs.get("use_push_randomization", True),
            use_observation_noise=kwargs.get("use_observation_noise", True),
        )
        eval_env = train_env
        record_env = train_env
