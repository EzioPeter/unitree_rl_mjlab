...
from .unitree_mujoco_parity import (
    unitree_go2_flat_unitree_mujoco_proprioceptive_expert_env_cfg,
)
...
register_mjlab_task(
    task_id="Unitree-Go2-Flat-Unitree-MuJoCo-Proprioceptive-Expert",
    env_cfg=unitree_go2_flat_unitree_mujoco_proprioceptive_expert_env_cfg(
        play=False
    ),
    play_env_cfg=unitree_go2_flat_unitree_mujoco_proprioceptive_expert_env_cfg(
        play=True
    ),
    rl_cfg=unitree_go2_rwm_pretrain_runner_cfg(),
    runner_cls=None,
