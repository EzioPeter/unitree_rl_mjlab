...
It exercises the same global top-alpha, V13 reward/n-step, mutable replay, and
...
class RuleBootstrapConfig:
    ...
    def sha256(self) -> str:
        ...
        return canonical_sha256(
            {
                "version": "go2_trace_rule_bootstrap_v3",
...
def score_rule_summaries(
    ...
    """Return token-free rule scores for one global top-alpha selection."""
