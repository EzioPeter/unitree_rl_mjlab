...
from .schemas import PROMPT_HASH
...
class CumulativeFeedbackManager:
    ...
    def load_state_dict(self, state: Mapping[str, Any]) -> None:
        ...
        if "planar_command_scales" not in state:
            raise ValueError(
                "Feedback checkpoint predates six-region pairing and cannot be "
                "safely resumed without an explicit migration."
            )
