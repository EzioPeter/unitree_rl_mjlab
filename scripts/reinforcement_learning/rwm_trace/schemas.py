...
SUMMARY_SCHEMA_VERSION = "go2_trace_trajectory_summary_v3"
...
PROMPT_VERSION = "go2_trace_feedback_prompt_v3"
...
PROMPT_HASH = canonical_sha256(
    {
        ...
        "source_kinds": FORMAL_SOURCE_KINDS,
        "pairing_policy": {
            "regions": ("front", "back", "left", "right", "pure_yaw", "stand"),
            "planar_boundaries": (
                "normalized_vy=normalized_vx",
                "normalized_vy=-normalized_vx",
            ),
            "within_region_fraction": 0.8,
            "cross_region_fraction": 0.2,
            "balance_regions": False,
        },
        "priority": (
            "velocity_tracking_primary",
            "posture_survival_veto",
            "control_contact_secondary",
...
def schema_manifest() -> dict[str, Any]:
    return {
        ...
        "pair": {"version": PAIR_SCHEMA_VERSION},
